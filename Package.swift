...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/happn-app/XibLoc.git", branch: "fix/adding_swiftui_library"),
		.package(url: "https://github.com/xcode-actions/CLTLogger.git", exact: "0.5.1")
	],
	targets: [
